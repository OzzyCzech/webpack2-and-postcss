...
6. Pokud budeme potřebovat načítat v CSS **statické soubory**, například obrázky přes `url()`,
	...
	A ještě upravit `webpack.config.js` přidáním [url-loader](https://github.com/webpack-contrib/url-loader) a [img-loader](https://github.com/thetalecrafter/img-loader):
